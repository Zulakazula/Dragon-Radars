...
public class FireRadarScreen extends Screen {
    ...
    private List<TrackedDragon> calculateFilteredList() {
        ...
        for (int i = 0; i < FireRadarSettings.INSTANCE.globalResults.size(); i++) {
            DragonInfo info = FireRadarSettings.INSTANCE.globalResults.get(i);
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (isWaitingForResults) {
            ...
            if (FireRadarSettings.INSTANCE.hasPerformedSearch) renderStatsBox(guiGraphics, statsX, 40);
        ...
        if (showStageBox) renderPopupBox(guiGraphics, stageNames, FireRadarSettings.INSTANCE.selectedStages, 125, 105);
        if (showGenderBox) renderPopupBox(guiGraphics, genderNames, FireRadarSettings.INSTANCE.selectedGenders, 125, 130);
    }
